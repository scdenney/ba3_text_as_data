...
**NOTE:** A balanced subsample of 120 articles (30 from each economic era) was randomly selected to create a manageable, era-representative reduced corpus for student analysis. This is not the full, original corpus.
...
- **kjyg_corpus.csv** — UTF-8 CSV version compatible with Orange Data Mining.  
