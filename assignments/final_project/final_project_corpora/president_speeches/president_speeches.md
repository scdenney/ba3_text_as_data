...
**NOTE:** A subsample of approximately 150 speeches per 'era' was randomly selected to create a manageable, era-representative reduced corpus for student analysis. This is not the full, original corpus.
...
## Special Instruction for Corpus Curators (attn: Moro, Bhowmick)

Students serving as *corpus curators* must use at least one of the added subgroup variables in doing their analysis. Examples include:

---

## File Formats

- **president_speeches_reduced.csv** — UTF-8 CSV version compatible with Orange Data Mining.  